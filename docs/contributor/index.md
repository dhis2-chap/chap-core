...
## Getting Started
- [Getting Started](getting_started.md) - Introduction for new contributors
- [Setup Guide](chap-contributor-setup.md) - Setting up your development environment
- [Windows Setup](windows_contributors.md) - Windows-specific setup instructions

## Understanding the Codebase
- [Code Overview](code_overview.md) - Architecture and code structure
- [Vocabulary](vocabulary.md) - Domain-specific terminology
