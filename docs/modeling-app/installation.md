...
!!! tip "First-time Setup (New Users)"
    Installing Chap Core for the first time? Follow the [First-time Setup guide](fresh-installation.md).

!!! info "Updating to a New Version"
    Already have Chap Core installed and want to upgrade to a newer version? Follow the [Update guide](upgrading-installation.md).
