...
- The two main RMarkdown files are `DHIS2-Module1.Rmd` (Exploration) and `DHIS2-Module2.Rmd` (Model selection), available in the GHRmodel repository linked above.
