...
def test_print_location_lookup_noninatime():
    ...
    location_lookup.add_location('Paris')
    print(location_lookup)
    assert str(location_lookup) == '{\'Oslo\': Location(Oslo, Norge, (59.9133301, 10.7389701, 0.0)), \'Paris\': Location(Paris, Île-de-France, France métropolitaine, France, (48.8534951, 2.3483915, 0.0))}'
