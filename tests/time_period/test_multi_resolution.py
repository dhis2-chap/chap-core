...
def test_pack_to_period():
    day_range = PeriodRange.from_time_periods(Day.single_entry(2020, 0, 0), Day.single_entry(2020, 1, 28))
...
def test_multi_resolution_weather_data(climate_database):
    ...
    time_period, packed = pack_to_period(daily_weather.time_period, daily_weather.rainfall, Month)
