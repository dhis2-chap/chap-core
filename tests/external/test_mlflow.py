...
from climate_health.external.mlflow import ExternalMLflowModel, MlFlowTrainPredictRunner
...
def test_mlflow_model_train(models_path, train_data_pop, future_climate_data):
    ...
    model = ExternalMLflowModel(runner, working_dir=models_path / model_directory)
