...
def day_range(start_period, end_period, exclusive_end):
    pd_start = pd.Period(year=start_period.year, month=start_period.month+1, day=start_period.day+1, freq='D')
    pd_end = pd.Period(year=end_period.year, month=end_period.month+1, day=end_period.day+1, freq='D')
