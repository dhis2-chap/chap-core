...
def plot_multiperiod(climate_data: ClimateData, health_data: HealthData, head: None | int = None) -> Figure:
    ...
    last_month, last_year = climate_df.time_period.iloc[-1].month, climate_df.time_period.iloc[-1].year
    ...
    disease_trace = px.line(health_df, x="time_period", y="disease_cases", title="Climate Health Data", line_shape='vh')
