...
try:
    from .jax_models.regression_model import (
        RegressionModel,
        HierarchicalRegressionModel,
    )
    ...
    models = {
        # **extract_models(regression_model),
        **extract_models(simple_ssm),
        **extract_models(specs),
        **extract_models(hierarchical_model),
    }
    try:
