from omnipy import (DagFlowTemplate, FuncFlowTemplate,
                    LinearFlowTemplate, PandasDataset,
...
def create_prev2new_keymap(time_period_col_name: str,
                           rain_data_file_name: str,
                           temp_data_file_name: str,
                           disease_data_file_name: str) -> dict[str, str]:
    return {time_period_col_name: 'time_period',
...
def standardize_separated_data_func_flow(
    ...
    table_transposed_renamed_colnames_ds = rename_col_names.run(
        table_transposed_ds,
        prev2new_keymap=create_prev2new_keymap(time_period_col_name,
                                               rain_data_file_name,
                                               temp_data_file_name,
