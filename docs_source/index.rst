...
This website contains documentation about how to use Chap for **modelers**, **contributors**, **developers**, or **system administrators wanting to use Chap with DHIS2/Modeling App**. For more general information about the Chap project, we refer to `the CHAP project wiki <https://github.com/dhis2-chap/chap-core/wiki>`_. 
