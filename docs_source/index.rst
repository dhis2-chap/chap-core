...
**Chap Core** is the name of the `backend service <https://github.com/dhis2-chap/chap-core>` and `Python package <https://pypi.org/project/chap-core/>` in the Chap Modeling Platform. This website contains documentation about how to use Chap Core for **modelers**, **contributors**, **developers**, or **system administrators wanting to use Chap with DHIS2/Modeling App**. For more general information about the Chap project, we refer you to `the Chap Modelling Platform wiki <https://github.com/dhis2-chap/chap-core/wiki>`_. 
