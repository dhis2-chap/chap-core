...
header_Input_pros<-fluidRow(inputPanel(surv.Input_prospective,
                                       column(12,offset=7,output_dist_pros)))
...
dashboad_elements_New_model<-tabPanel("New Model",
                                         fluidPage(
...
dashboad_elements_New_model_pros<-tabPanel("Prospective analysis (New Model)",
