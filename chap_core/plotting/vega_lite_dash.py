...
from chap_core.assessment.metrics import (
    ...
    PeakWeekLagMetric,              
    SamplesAboveTruth)  
from evaluation_plot import MetricByHorizonV2Mean, MetricMapV2, MetricByTimePeriodV2Mean, MetricByHorizonV2Sum, MetricByTimePeriodV2Sum
...
def _horizon_section(flat_obs: FlatObserved, flat_fc: FlatForecasts, geojson: Optional[dict]):
    ...
    above_truth_df = _compute_metric_df(SamplesAboveTruth, flat_obs, flat_fc)
    ...
    charts.append(MetricByHorizonV2Sum(above_truth_flat).plot().properties(
        title={
...
def _time_section(flat_obs: FlatObserved, flat_fc: FlatForecasts):
    ...
    charts.append(MetricByTimePeriodV2Sum(above_truth_flat).plot().properties(
            title={
