...
import pydantic
import numpy as np
from numpy.random import normal, poisson, negative_binomial
...
class AdditiveSimulator(Simulator):
    ...
    def simulate(self, data_dims: DatasetDimensions) -> DataSet:
        ...
        observations = [
            Observation(period=data_dims.time_periods[time_idx],
        ...
        return DataSet(
            ...
            covariates=data_dims.features + [data_dims.target],
