...
class OpenDengueDataSet:
    ...
    def subset(self, country_name: str, spatial_resolution: Literal['Admin1', 'Admin2'] = 'Admin1',
    ...
    def as_dataset(self, country_name: str, spatial_resolution: Literal['Admin1', 'Admin2'] = 'Admin1',
                   temporal_resolution='Week'):
