...
# currently uses OpenAPI.BASE='/v1', so common endpoints like /health and
# /compatibility are requested at /v1/health and /v1/compatibility. This
# duplicate mount ensures those requests still work. Hidden from the OpenAPI
# schema.
