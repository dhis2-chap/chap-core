...
def register_service(
    ...
    # Eagerly store the template and check the registered revision against it, so a
    # model developer sees a mismatch in their own service logs. Best-effort: a sync
