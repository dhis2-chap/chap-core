...
def seed_with_session_wrapper(session_wrapper):
    ...
    seeded_models = [
        ModelSpec(
            ...
            description="A simple naive model only to be used for testing purposes. Assumes that...",
            author="CHAP team",
        ...
        ModelSpec(
            ...
            description="Modified version of the World Health Organization (WHO) EWARS model. EWARS is a Bayesian hierarchical model implemented with the INLA library. Changes include...",
            author="CHAP team",
            organization="HISP Centre, University of Oslo",
            organization_logo_url="https://landportal.org/sites/default/files/2024-03/university_of_oslo_logo.png",
